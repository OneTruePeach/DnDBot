...
const { getVoiceConnection, createAudioResource, entersState, StreamType, AudioPlayerStatus, getVoiceConnections } = require('@discordjs/voice');
...
module.exports = {
  ...
  async execute(interaction) {
    ...
    console.log(`${new Date().toLocaleString()} - Main     | Readychecking ${vcChannel.name}`);

    let i = 0;
    var userString = ""
    var userList = [];
    var userReadyStates = [];
    var checkHasEnded = false;
    ...
    vcConnection = vcConnections.get(interaction.guild.id);
